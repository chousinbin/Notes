...
- The aim of the design workflow is to  refine the analysis workflow until material is in a form that can be implemented by the Programmers
...
- Traceability of artfacts is an important require ment for success ful testing
