...
2. The resource abstraction and control of the ____ layer is comprised of operational and management tools that are often based on virtualization platforms.
   - [ ] A. transport
   - [ ] B. network
...
4. Which factor leads to suffer network service-level degradation? ________
...
17. (单选题) Dynamic scaling IT resources out or in based on parameters previously defined by the cloud consumer commonly referred to as ____.
...
19. To avoid the resource constraint and resource borrowing conditions, ______ is used.
    - [ ] A. Zero Downtime Architecture
