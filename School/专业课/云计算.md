...
## 3.2 basic concept and terminology *
...
## 5.1 Broadband Network and Internet Architecture
...
5. **Hardware based** 补图
   ...
   directly install to physical host hardware  bypass the host OS， more 更有效
